$combinations = [
	...
	'
		...
		--duration=600
		--queries=100M
		--reporters=Backtrace,ErrorLog,Deadlock,DatabaseConsistency
    --validators=TransformerNoComparator
    --transformers=Count,DisableIndexes,ExecuteAsDeleteReturning,ExecuteAsDerived,ExecuteAsExecuteImmediate,ExecuteAsInsertSelect,ExecuteAsSelectItem,ExecuteAsUnion,ExecuteAsUpdateDelete,ExecuteAsView,Having,OrderBy,ExecuteAsPreparedTwice,ExecuteAsTrigger,ExecuteAsSPTwice,ExecuteAsFunctionTwice
  ...
  [
    '--basedir=/data/bld/bb-10.2-monty',
    '--basedir=/data/bld/bb-10.2-monty-rel-asan'
  ]
];
